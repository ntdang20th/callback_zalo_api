...
class XQueryLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "operator": [
            ...
            (r"(instance)(\s+)(of)\b", bygroups(Keyword, Text, Keyword), "itemtype"),
            (r"(treat)(\s+)(as)\b", bygroups(Keyword, Text, Keyword), "itemtype"),
            (
        ...
        "root": [
            ...
            (
                ...
                bygroups(
                    Keyword.Declaration, Text, Keyword.Declaration, Text, Name.Variable
                ),
                "varname",
            ),
